...
function display_round_1b_results($user_ID) {
    ...
    <ul>
        ...
        <li>Player 2 donated $round_1b_AI_1_contribution ECUs to the common pool</li>
        <li>Player 3 donated $round_1b_AI_2_contribution ECUs to the common pool</li>
        <li>Player 4 donated $round_1b_AI_3_contribution ECUs to the common pool</li>
    </ul>
    ...
    <ul>
        ...
        <li>Player 2 has $round_1b_AI_1_ECU_at_end ECU's</li>
        <li>Player 3 has $round_1b_AI_2_ECU_at_end ECU's</li>
        <li>Player 4 has $round_1b_AI_3_ECU_at_end ECU's</li>
    </ul>
    <br>
    ");
...
if (isset($_POST['submit'])) {
    ...
    global $round_1b_player_contribution;
    global $round_1b_AI_1_ECU_at_end;
    $round_1c_AI_1_contribution = calculate_AI_contribution($round_1b_player_contribution, $round_1b_AI_1_ECU_at_end);
    global $round_1b_AI_2_ECU_at_end;
    $round_1c_AI_2_contribution = calculate_AI_contribution($round_1b_player_contribution, $round_1b_AI_2_ECU_at_end);
    global $round_1b_AI_2_ECU_at_end;
    $round_1c_AI_3_contribution = calculate_AI_contribution($round_1b_player_contribution, $round_1b_AI_2_ECU_at_end);
