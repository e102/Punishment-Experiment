...
echo("
    ...
    <ul class='list-group'>
        <li class='list-group-item'><span style='color: $player_colour'>You</span>: $player_final_ECU ECUs</li>
        <li class='list-group-item'><span style='color: $AI_1_colour'>$AI_1_colour</span>: $AI_1_final_ECU ECUs</li>
        <li class='list-group-item'><span style='color: $AI_2_colour'>$AI_2_colour</span>: $AI_2_final_ECU ECUs</li>
        <li class='list-group-item'><span style='color: $AI_3_colour'>$AI_3_colour</span>: $AI_3_final_ECU ECUs</li>
    </ul>
    <br>
    ");
